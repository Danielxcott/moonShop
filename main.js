...
products.forEach((value) => {
  value.addEventListener("click", (e) => {
    if (e.path[2].classList.contains("col-12" || "col-lg-3")) {
      ...
      e.path[2].childNodes[3].childNodes[3].childNodes[0].classList.add(
        "active"
      );
      ...
      e.path[3].childNodes[3].childNodes[3].childNodes[0].classList.add(
        "active"
      );
    }
  });
  ...
  value.addEventListener("mouseout", (e) => {
    if (e.path[2].classList.contains("col-12" || "col-lg-3")) {
      setTimeout((_) => {
        ...
        e.path[2].childNodes[3].childNodes[3].childNodes[0].classList.remove(
          "active"
        );
      }, 1200);
    } else if (e.path[3].classList.contains("col-12" || "col-lg-3")) {
      setTimeout((_) => {
        ...
        e.path[3].childNodes[3].childNodes[3].childNodes[0].classList.remove(
          "active"
        );
      }, 1200);
    }
